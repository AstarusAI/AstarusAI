...
export const CTA = () => {
  return (
    <motion.section
      className="py-24 px-4 relative overflow-hidden bg-gradient-to-b from-white via-gray-50 to-white"
      initial="hidden"
      whileInView="visible"
      ...
      <div className="container relative z-10">
        ...
        >
          <Card className="max-w-4xl mx-auto p-12 bg-white border-2 border-primary/20 shadow-2xl relative overflow-hidden group">
            <div className="absolute top-0 right-0 w-80 h-80 bg-gradient-to-br from-primary/10 via-secondary/5 to-transparent rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
            <div className="text-center space-y-8 relative z-10">
              ...
              <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">Ready to Learn More?</h2>
              ...
              <motion.div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4" variants={fadeInUp(0.2)}>
                <Link to="/contact">
                  <Button size="lg" className="group relative bg-gradient-to-r from-primary to-primary/80 text-white font-semibold px-8 py-6 rounded-lg shadow-xl hover:shadow-primary/50 hover:scale-105 transition-all duration-300 border-2 border-primary/20">
