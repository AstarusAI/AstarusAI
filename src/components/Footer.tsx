...
export const Footer = () => {
  ...
  return (
    <footer className="py-16 px-4 border-t-2 border-gray-200 bg-gradient-to-b from-gray-50 to-white">
      <div className="container">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            {/* Company info */}
            <div className="space-y-4">
              <h3 className="text-2xl font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Astarus</h3>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3 text-sm">
                <li><a href="mailto:hello@astarus.ai" className="text-gray-700 hover:text-primary transition-colors font-medium">hello@astarus.ai</a></li>
