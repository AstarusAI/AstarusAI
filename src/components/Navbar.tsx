        ...
        <div className="rounded-b-3xl bg-black backdrop-blur-xl border border-primary/20 border-t-0 shadow-2xl px-6">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:block">
              <Link to="/contact">
                <Button className="bg-primary text-white hover:bg-primary/90 font-semibold shadow-lg hover:shadow-primary/50 transition-all">
                  Get in Touch
                </Button>
              </Link>
            </div>
          ...
          {isOpen && (
            <div className="md:hidden py-4 space-y-4 animate-fade-in bg-black backdrop-blur-xl rounded-b-3xl border-t border-primary/20">
              ...
              <Link
                ...
                className="px-6"
              >
                <Button className="w-full bg-primary text-white hover:bg-primary/90 font-semibold shadow-lg">
                  Get in Touch
                </Button>
              </Link>
            </div>
